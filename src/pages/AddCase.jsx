  ...
  return (
    <div className="p-2 md:p-6 space-y-2 md:space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 shadow-sm flex flex-col pt-1 mt-2">
        {/* Mobile View: Cards */}
        <div className="md:hidden flex flex-col gap-2 p-2 bg-slate-50/50 pb-20">
        ...
        {/* Desktop View: Table */}
        <div className="hidden md:block overflow-x-auto overflow-y-auto h-[calc(100vh-240px)] [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
